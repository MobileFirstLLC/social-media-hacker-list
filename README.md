...
| 16. | 🟨 | | [INDownloader](https://indownloader.app/) | Web | Instagram Downloader |
...
| 5. | 🟫 | [❋](https://github.com/tomquirk/linkedin-api) | [Linkedin API](https://github.com/tomquirk/linkedin-api) | Python | Linkedin API for Python |
| 6. | 🟧 | | [LinkedIn IP List](https://github.com/SecOps-Institute/LinkedInIPLists) | Dataset | List of IPv4 and IPv6 addresses used by LinkedIn crawlers |
...
|  # | |  | Name | Platform | Description |
|:--:| --- | --- | --- | --- | --- |
| 1. | 🟧 | | [GhostCodes](https://www.ghostcodes.com/) | Web, iOS, Android | Discover new people on Snapchat | IT DOESN'T EVEN WORK the search button does not work 
